...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full backdrop-blur-md border-b"
      style={{ background: 'rgba(14,14,17,0.85)', borderColor: 'rgba(76,70,63,0.3)' }}>
      <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <a href="#" className="flex items-center gap-2 group">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <Badge variant="secondary" className="px-1.5 py-0.5 text-[9px] uppercase tracking-wider">
              ops
            </Badge>
          </div>
        </a>
        ...
        {/* Desktop Nav */}
        <nav className="hidden md:flex items-center gap-6" style={{ color: 'var(--on-surface-variant)', fontSize: '13px' }}>
